...
class HomeViewController: BaseViewController , UITableViewDelegate , UITableViewDataSource{
    ...
    override func loadData() {
        ...
        let dict:NSDictionary = ["city": "", "jobStyle":"", "paySort":"", "pageNum":"20", "page":"1"]
        
        
        HttpsRequest.shareRequest().startRequest(url: "http://gateway.tgucredit.com/recruit/queryRecruitList", paraments: dict, requestType: RequestType.POST_REQUEST, successBack: { (dict) in
            print(dict)
